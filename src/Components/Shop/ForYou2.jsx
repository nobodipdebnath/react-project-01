          ...
          <div className="w-[75%] shadow-xl mb-10 px-10 bg-white pt-10 rounded-lg">
            ...
            <div className="flex justify-center items-center pb-10">
              <div className="flex gap-4">
                ...
                <button className="px-3 py-3 border rounded-lg bg-white cursor-pointer">1</button>
                <button className="px-3 py-3 border rounded-lg bg-white cursor-pointer">2</button>
                <button className="px-3 py-3 border rounded-lg bg-white cursor-pointer">3</button>
                <button className="px-3 py-3 border rounded-lg bg-white cursor-pointer">
                  <FontAwesomeIcon icon={faEllipsis} />
                </button>
                <button className="px-3 py-3 border rounded-lg bg-white cursor-pointer">199</button>
                <button className="px-3 py-3 border rounded-lg bg-white cursor-pointer">
